...
func TestValidateOTP_RFC6238(t *testing.T) {
	...
	vectors := []struct {
		...
		{59, 8, map[Algorithm]string{SHA1: "94287082", SHA256: "46119246", SHA512: "90693936"}},
		{1111111109, 8, map[Algorithm]string{SHA1: "07081804", SHA256: "68084774", SHA512: "25091201"}},
		{1111111111, 8, map[Algorithm]string{SHA1: "14050471", SHA256: "67062674", SHA512: "99943326"}},
		{1234567890, 8, map[Algorithm]string{SHA1: "89005924", SHA256: "91819424", SHA512: "93441116"}},
		{2000000000, 8, map[Algorithm]string{SHA1: "69279037", SHA256: "90698825", SHA512: "38618901"}},
		{20000000000, 8, map[Algorithm]string{SHA1: "65353130", SHA256: "77737706", SHA512: "47863826"}},
	}
...
func BenchmarkValidateOTP(b *testing.B) {
	...
	for _, tt := range tests {
		b.Run(fmt.Sprintf("%s/%d", tt.algo.String(), tt.digits), func(b *testing.B) {
			...
			for i := 0; i < b.N; i++ {
				code, err := deriveOTP(secrets[tt.algo], uint64(i), tt.digits, tt.algo)
				if err != nil {
